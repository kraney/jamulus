...
#define TOOLTIP_COM_END_TEXT                                                                         \
    "<br><div align=right><font size=-1><i>" +                                                       \
        QCoreApplication::translate("global", "For more information use the "                        \
                                              "What's "                                              \
                                              "This"                                                 \
                                              " help (help menu, right mouse button or Shift+F1)") + \
        "</i></font></div>"
...
{
public:
    CCustomEvent(int iNewMeTy, int iNewSt, int iNewChN = 0) : QEvent(QEvent::Type(QEvent::User + 11)), iMessType(iNewMeTy), iStatus(iNewSt),
                                                              iChanNum(iNewChN) {}
